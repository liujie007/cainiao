...
public class PullToRefreshView extends LinearLayout {
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_CANCEL:
			...
			// Log.d("","FLAG--pull more topMargin="+topMargin
			...
			if (mPullState == PULL_DOWN_STATE) {
				...
				// 由于此时的headview是隐藏的。topmargin为它的高度，所以这里要加上它的高度去算偏移量
				if (Math.abs(topMargin + mHeaderViewHeight) >= mHeaderViewHeight) {
					// 开始执行footer 刷新
					// Log.d("","FLAG------kaishi shuaxin----");
	...
	public void onHeaderRefreshComplete() {
		...
		/*mHeaderImageView.setImageResource(R.drawable.kc_ic_pulltorefresh_arrow);
		mHeaderTextView.setText(R.string.kc_pull_to_refresh_pull_label);*/
	...
	public void onFooterRefreshComplete() {
		...
		/*mFooterImageView
				.setImageResource(R.drawable.kc_ic_pulltorefresh_arrow_up);
		mFooterTextView.setText(R.string.kc_pull_to_refresh_footer_pull_label);*/
