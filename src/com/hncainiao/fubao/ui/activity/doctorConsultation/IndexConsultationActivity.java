...
public class IndexConsultationActivity extends BaseActivity {
	Context mContext;
	...
	private void InitView() {
		mContext=this;
		setTitle("医生咨询");
		((TextView) findViewById(R.id.myzixun)).setVisibility(View.VISIBLE);
	...
	private OnClickAvoidForceListener l = new OnClickAvoidForceListener() {
		...
		public void onClickAvoidForce(View v) {
			...
			case R.id.yizhen:
				...
				break;
			case R.id.freezixun:
				intent=new Intent(mContext,FreeconsultationActivity.class);
				startActivity(intent);
				overridePendingTransition(R.anim.push_left_in, R.anim.push_left_out);
				break;
			case R.id.llchild:
				intent=new Intent(mContext,HotzixunActivity.class);
